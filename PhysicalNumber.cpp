...
namespace ariel {
    ...
    std::string getType(int typeNum);
  ...
  PhysicalNumber::PhysicalNumber(double value, Unit type){
     ...
     void throwCheck(const PhysicalNumber& a,const PhysicalNumber& b){
         if(returnUnit(a,b) == -1)
         throw (" two different Unit types ");
     }
     
     Unit StringToType(string str){

    if(str=="km") return Unit::KM;
   else if(str=="m") return Unit::M;
   else if(str=="cm") return Unit::CM;
   else if(str=="hour") return Unit::HOUR;
   else if(str=="min") return Unit::MIN;
  else if(str=="sec") return Unit::SEC;
  else  if(str=="ton") return Unit::TON;
  else  if(str=="kg") return Unit::KG;
  else  if(str=="g") return Unit::G;
         else{
